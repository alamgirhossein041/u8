...
func main() {
	...
	//var fn *tart.Sma
	//err = b.Vm.ExportTo(bi.GetExported("sma"), &fn)

	//for i := 0; i < 20; i++ {
	//	close.Update(float64(i))
	//	height.Update(float64(i) + 1.5)
	//	low.Update(float64(i) * 1.5)
	//}
	//ta := tart.Ta{}
	//sma := ta.Ema(testClose, 5)
	...
	///jsOptions := exports.Get("close")
	//var fn func() float64
	//err = vm.ExportTo(vm.Get("a"), &fn)
	//rsx := vm.Get("c").Export().(*inc.SMA)

	//jsobj := b.Vm.NewObject()

	//jsobj.
	//closeFn, _ := goja.AssertFunction(exports.Get("close"))
	//closeFn(goja.Undefined(), "Update", 3333)
	//b.Set("close", close)
	//b.Set("high", high)
	//b.Set("low", low)
	//var Close floats.Slice

	//Close := exports.Get("close").Export().(floats.Slice)
	//High := exports.Get("high").Export().(floats.Slice)
	//
	//////err = b.Vm.exports.Get("close")
	////fmt.Println(exports.Get("close"))
	//cc := exports.Get("fuck")
	//fmt.Println(cc, "fuck")
	//err = bi.Runtime.ExportTo(cc, &Close)
	//fmt.Println(err)
	//fmt.Println(exports.Get("close"), "close")
	//cci1 := ok.NewCci(5)
